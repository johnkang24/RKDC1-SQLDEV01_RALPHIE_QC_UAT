...
CREATE PROCEDURE [dbo].[GetSeedsByAdvJobNo_NEW]
(
	@AdvJobNo VARCHAR(50),
...
--SET @AdvJobNo = '98076'
--SET @DelivrableId = '132748'	--50963 50957
--SET @ResetSeeds = 1
--SET @testing = 1
...
IF @ResetSeeds=1 BEGIN
	...
	BEGIN
		...
		SELECT @max_serial=COALESCE(MAX(serial),0) FROM ORIGINAL WHERE FileID=@FILE_ID
